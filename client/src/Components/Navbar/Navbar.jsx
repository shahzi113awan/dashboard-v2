                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="inn-app-tabs dash-navvbar">
                                            ...
                                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="pills-inte-dash-tab" data-toggle="pill" href="#pills-inte-dash" role="tab" aria-controls="pills-inte-dash" aria-selected="false">INTEGRATION  DASHBOARD</button>
                                                </li>

                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="pills-trading-dash-tab" data-toggle="pill" href="#pills-trading-dash" role="tab" aria-controls="pills-trading-dash" aria-selected="false">TRADING DASHBOARD</button>
                                                </li>

                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="pills-arch-dash-tab" data-toggle="pill" href="#pills-arch-dash" role="tab" aria-controls="pills-arch-dash" aria-selected="false">ARCHIVE DASHBOARD</button>
                                                </li>
                                            </ul>
